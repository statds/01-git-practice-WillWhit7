...
+ Whitney, William
    - Learn more about the field of data science and all it entails
    - Discover if Git is useful for future career opportunities and project management
    - Challenhge myself in a difficult, fast-paced class.
+ Win, Marlins
